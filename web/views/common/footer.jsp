...
<div id="layout_footer">	
		...
		<div class="wrap_inner">
			<ul>
				...
				<li class="cs_sns">
					...
					<ul class="sns">
						<li><a><img src="/tp/views/common/data/skin/fruit_puro_gls/images/design/ico_facebook.png" alt="페이스북" /></a></li>
						<li><a><img src="/tp/views/common/data/skin/fruit_puro_gls/images/design/ico_twitter.png" alt="트위터" /></a></li>
						<li><a><img src="/tp/views/common/data/skin/fruit_puro_gls/images/design/ico_instagram.png" alt="인스타그램" /></a></li>		
						<li><a><img src="/tp/views/common/data/skin/fruit_puro_gls/images/design/ico_naverblog.png" alt="네이버블로그" /></a></li>
						<li><a><img src="/tp/views/common/data/skin/fruit_puro_gls/images/design/ico_kakaostory.png" alt="카카오스토리" /></a></li>					
					</ul>
				</li>
				...
				<li class="cs_menu">
					<h4>SHOP MENU</h4>
					<ul class="menu">
						<li><img src="/tp/views/common/data/skin/fruit_puro_gls/images/design/cs_i01.png" alt="" /><span class="on"></span></li>	
						<li><img src="/tp/views/common/data/skin/fruit_puro_gls/images/design/cs_i02.png" alt="" /><span class="on"></span></li>
						<li><img src="/tp/views/common/data/skin/fruit_puro_gls/images/design/cs_i03.png" alt="" /><span class="on"></span></li>
						<li><img src="/tp/views/common/data/skin/fruit_puro_gls/images/design/cs_i04.png" alt="" /><span class="on"></span></li>
						<li><img src="/tp/views/common/data/skin/fruit_puro_gls/images/design/cs_i05.png" alt="" /><span class="on"></span></li>
						<li><img src="/tp/views/common/data/skin/fruit_puro_gls/images/design/cs_i06.png" alt="" /><span class="on"></span></li>
					</ul>
				</li>
			</ul>
		</div>
	...
	<div class="copy_wrap">
		<div class="wrap_inner relative">
			<h1><a href="index.jsp" target="_top"><img src="/tp/views/common/data/skin/fruit_puro_gls/images/design/logo.png" alt="LOGO" /></a></h1>		
			<ul class="copy">
...
<br />
			...
			<img src="/tp/views/common/data/icon/escrow_mark/kcp.png"  style="max-width:80px;" />
			</span>		
			<!-- //에스크로표기 -->
