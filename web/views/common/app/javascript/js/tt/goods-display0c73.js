		...
		if(decoration){
			...
			if(decoration['image_overay_plus2'] && decoration['image_overay_type'] != 'all'){
				...
				if($(".goodsDisplayImageOverayPlus2",this).length){
					...
					var overay2Obj = $("<div class='goodsDisplayImageOverayPlus2'><div class='goodsDisplayImageOverayPlus2Iwrap'><div class='goodsDisplayImageOveray2BgPlus'></div></div></div>");
